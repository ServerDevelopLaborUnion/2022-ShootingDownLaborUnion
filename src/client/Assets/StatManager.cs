...
public class StatManager : MonoBehaviour
{
    ...
    public void UpdateText(PlayerBase _base, Weapon _weapon = null)
    {
        ...
        if(_weapon != null)
        {
            _hpText.text = $"{_base.Stat.HP - _weapon.Stat.HP} +({_weapon.Stat.HP})";
            _atkText.text = $"{_base.Stat.AD - _weapon.Stat.AD} +({_weapon.Stat.AD})";
            _defText.text = $"{_base.Stat.Def - _weapon.Stat.Def} +({_weapon.Stat.Def})";
            _speedText.text = $"{_base.Stat.Speed - _weapon.Stat.Speed} +({_weapon.Stat.Speed})";
            _atkSpeedText.text = $"{_base.Stat.AtkSpeed - _weapon.Stat.AtkSpeed} +({_weapon.Stat.AtkSpeed})";
            _atkRangeText.text = $"{_base.Stat.AtkRange - _weapon.Stat.AtkRange} +({_weapon.Stat.AtkRange})";

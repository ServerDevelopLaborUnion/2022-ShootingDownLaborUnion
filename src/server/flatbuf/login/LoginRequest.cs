...
public struct LoginRequest : IFlatbufferObject
{
  ...
  public static Offset<login.LoginRequest> CreateLoginRequest(FlatBufferBuilder builder,
  ...
  public static Offset<login.LoginRequest> EndLoginRequest(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<login.LoginRequest>(o);
  }
};
